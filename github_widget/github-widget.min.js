...
[];a=0;for(f=r.length;a<f;a++)if(l=r[a],!(!d.forks&&l.fork||(n=l.name.toLowerCase(),0<=v.call(p,n)))&&l.description){if(e++===g)break;k.push(h({parent:b,cls:"gw-repo-outer",kids:[h({cls:"gw-repo",kids:[h({cls:"gw-title",kids:[h({tag:"ul",cls:"gw-stats",kids:[h({tag:"li",text:l.watchers,cls:"gw-stars"}),h({tag:"li",text:l.forks,cls:"gw-forks"})]}),h({tag:"a",href:l.html_url,text:l.name,cls:"gw-name"})]}),null!=l.language?h({cls:"gw-lang",text:l.language}):void 0,h({cls:"gw-repo-desc",text:l.description})]})]}))}return k};
